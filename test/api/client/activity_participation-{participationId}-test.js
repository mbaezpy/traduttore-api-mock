...
describe('/activity_participation/{participationId}', function() {
  describe('get', function() {
    it('should respond with 200 successful operation', function(done) {
      ...
      /*eslint-enable*/
      api.get('/api/v1.0/activity_participation/{participationId PARAM GOES HERE}')
  ...
  describe('put', function() {
    it('should respond with 204 Successful operation', function(done) {
      api.put('/api/v1.0/activity_participation/{participationId PARAM GOES HERE}')
      .set('Content-Type', 'application/json')
      .send({
        body: 'DATA GOES HERE'
      })
