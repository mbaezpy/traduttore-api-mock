...
describe('/feedback/{feedbackId}/comments', function() {
  describe('get', function() {
    it('should respond with 200 successful operation', function(done) {
      ...
      /*eslint-enable*/
      api.get('/api/v1.0/feedback/{feedbackId PARAM GOES HERE}/comments')
  ...
  describe('post', function() {
    it('should respond with 201 Successful operation', function(done) {
      api.post('/api/v1.0/feedback/{feedbackId PARAM GOES HERE}/comments')
      .set('Content-Type', 'application/json')
      .send({
        body: 'DATA GOES HERE'
      })
