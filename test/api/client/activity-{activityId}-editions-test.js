...
describe('/activity/{activityId}/editions', function() {
  describe('get', function() {
    it('should respond with 200 successful operation', function(done) {
      ...
      /*eslint-enable*/
      api.get('/api/v1.0/activity/{activityId PARAM GOES HERE}/editions')
  ...
  describe('post', function() {
    it('should respond with 201 Successful operation', function(done) {
      api.post('/api/v1.0/activity/{activityId PARAM GOES HERE}/editions')
      .set('Content-Type', 'application/json')
      .send({
        body: 'DATA GOES HERE'
      })
